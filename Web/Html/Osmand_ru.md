...
### Инструкция по настройке кнопки для вызова Быстрых действий
...
* Нажмите и удерживайте на дюбое место на экране. Появится всплывающее меню.
* Выберите пункт `Действия`. Затем  `Загрузить карту`.
![](https://nnngrach.github.io/AnyGIS_maps/Web/Img/Osmand_pic_113.png)
* Появится меню с ползунком. Выберите до какого уровня приближения нужно скачивать карту. Индикатор покажет, какой объем, примерно, будет занимать карта. Нажмите ОК. 
