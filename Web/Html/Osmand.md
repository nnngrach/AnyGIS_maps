...
* Нужно сделать так, чтобы обновляемая карта не отображалась на экране. Если карта выбрана в качестве базового слоя, то переключите на другую. Если она выбрана в качестве подложки, то просто отключите отображение поджлоки. 
* Выключите OsmAnd, чтобы сбросить кэш.
* Включите OsmaAnd.
* Снова включите карту, которую требовалось обновить. 

После этих действий карта будет загружена заново.
