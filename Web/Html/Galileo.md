...
> Внимание! Карты на основе Яндекса составлены в нестандартной проекции. Чтобы они отображались как следует их приходится [преобразовывать][02] (грубо говоря, "фотошопить") на лету. Так что будьте готовы к тому, что эти карты будут загружаться сравнительно медленно.
...
* Перейдите по ссылке [Скачать пофайлово][2]. Вы окажетесь на страничке со списком карт. 
