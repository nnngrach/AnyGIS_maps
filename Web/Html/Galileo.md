...
> Внимание! Некоторые браузеры обрывают загрузку файла и просто показывают его текстовое содержимое на экране. Если такое происходит и у вас, при том на всех установленных браузерах, значит нужно закачивать карты через компьютер. Замечу, что стабильнее всего карты скачиваются через браузер Safari.
