...
Полойдё для всех динамически изменяющихся карт. Например, для всех карт и оверлеев с пробками: Яндекс Пробки, Google Traffic, Here Traffic, OpenSeaMap Traffic.
...
Для всех карт их категории "Спутниковые снимки". 
...
Для всех растровых ("отсканированных") карт время хранение кэша можно оставить без изменений, то есть бесконечным. Врядли их кто-то уже будет перерисовывать. Так что можно пропускать и не делать вышеописанные настройки для всех оставшиехся карт из категории "Евразия". 
