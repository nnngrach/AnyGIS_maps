...
### Полный набор
Если вы уже знаете, какие именно карты вам требуются, то этот вариант для вас. Просто скачайте архив на компьютер и выберите карты, которые вам требуются. В комплекте около сотни карт. Вот некоторые из них:
...
Этот набор включает в себя карты из подборок от других составителей: [Erelen][6], [Dreame][7], [ms.Galileo-app][8], [Custom-maps-sourse][9]. А так же многие карты из программы [SAS.Planet][10].
