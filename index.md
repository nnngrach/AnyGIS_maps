...
![](https://nnngrach.github.io/map-sources/Web/Img/locus_maplist.png)
...
И в завершение, замечу, что для загрузки многих карт применяется разработанный мной онлайн-преобразователь AnyGIS server. О том, как именно он работает, можно прочитать [здесь][03].
